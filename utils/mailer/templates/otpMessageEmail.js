const otpMessage = (userName, websiteName, otpCode, supportEmail) => {
  return `
    ...
    <head>
      ...
      <title>Change Your Email - ${websiteName}</title>
      <style>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Hi ${userName},</p>
          <p>You recently requested to change your email for your <strong>${websiteName}</strong> account.</p>
          <p>Use the OTP below to change your email:</p>
